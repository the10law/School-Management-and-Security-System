...
if(isset ($_POST['but1']))
{
 ...
 $regno=$_POST['regno'];
  ...
  $con_no=$_POST['no'];
  $mail=$_POST['email'];
  $qry="update student_master set name='$name', class='$class', section='$section', f_m_name='$f_m_name', address='$address', contact_no='$con_no', email_id='$mail' where regno='$regno'";
...
?>
  <form method="POST">
 <table>
<tr><td>Reg No:</td><td><input type="text" readonly name="regno" value='<?php echo $regno; ?>'>
</td></tr>

<tr><td>RFID No:</td><td><input type="text" name="rfid" value='<?php echo $rfid_no;?>' readonly>
</td></tr>
...
<a href="http://localhost/wordpress/student-database-viewer-editor/"><button type="button" value="goback" name="but1">Go Back</button></a>
